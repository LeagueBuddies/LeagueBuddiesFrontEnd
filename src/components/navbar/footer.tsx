...
const Footer: React.FC<Props> = ({ home, about, contact, twitter, github, facebook, linkedin }) => {
    return (
        <footer className="w-full flex items-center bg-footer text-white">
            <div className="w-full max-w-[1200px] flex flex-col justify-between px-4">
                ...
                <div className="flex items-end justify-between py-4 mt-28">
                    ...
                    <div className="flex space-x-4 socialicon">
                        <div className="min-w-[20px]"><a href={twitter}><FontAwesomeIcon icon={faTwitter} size="2x" /></a></div>
                        <div className="min-w-[20px]"><a href={github}><FontAwesomeIcon icon={faGithub} size="2x" /></a></div>
                        <div className="min-w-[20px]"><a href={facebook}><FontAwesomeIcon icon={faFacebook} size="2x" /></a></div>
                        <div className="min-w-[20px]"><a href={linkedin}><FontAwesomeIcon icon={faLinkedin} size="2x" /></a></div>
                        <div><p className="text-sm ml-4 text-footertext">© LeagueBuddies.com, 2023</p></div>
                    </div>
                </div>
            </div>
        </footer>
